"""
Graphs: Depth First Search: Recursive Solution

Select a node and select all possible paths from that node.

Apply recursively to each node exploring.

Use an Adjacenty List representation to store the graph
